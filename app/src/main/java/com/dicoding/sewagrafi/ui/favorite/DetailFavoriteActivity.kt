...
import com.dicoding.sewagrafi.ui.beranda.DatePickerFragment
import com.dicoding.sewagrafi.ui.beranda.DetailActivity
import com.dicoding.sewagrafi.ui.beranda.TimePickerFragment
...
class DetailFavoriteActivity : AppCompatActivity(), DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener, View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        favoriteViewModel = obtainFavoriteViewModel(this@DetailFavoriteActivity)
        bookViewModel = obtainBookViewModel(this@DetailFavoriteActivity)
        kameraViewModel = obtainKameraViewModel(this@DetailFavoriteActivity)
        ...
        binding.apply {
            ...
            bookViewModel.getBookDetail(item.merk).observe(this@DetailFavoriteActivity, {
                if (it != null) {
                    for (i in it.indices) {
            ...
            kameraViewModel.getKamera(item.merk).observe(this@DetailFavoriteActivity,{
                if (it[0].status == 1) {
            ...
            btnBook.setOnClickListener(this@DetailFavoriteActivity)
            btnFavorite.setOnClickListener(this@DetailFavoriteActivity)
            btnTanggalPinjam.setOnClickListener(this@DetailFavoriteActivity)
            btnTanggalKembali.setOnClickListener(this@DetailFavoriteActivity)
            btnJamPinjam.setOnClickListener(this@DetailFavoriteActivity)
            btnJamKembali.setOnClickListener(this@DetailFavoriteActivity)
        ...
        when(v.id) {
            ...
            R.id.btn_book -> {
                binding.apply {
                    ...
                    bookViewModel.getBookDetail(merk).observe(this@DetailFavoriteActivity, {
                        if (it != null) {
                            for (i in it.indices) {
                            ...
                            if (isCheckedBook) {
                                ...
                                alarmReceiver.setOneTimeAlarm(this@DetailFavoriteActivity, AlarmReceiver.TYPE_ONE_TIME,
                                    tanggalKembali,
                                    waktuKembali,
